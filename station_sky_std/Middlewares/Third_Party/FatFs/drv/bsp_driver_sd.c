...
static volatile bool sd_write_complate = 0;
static volatile bool sd_read_complate = 0;
...
bool is_sd_read_complete()
{
	return sd_read_complate;
}

bool is_sd_write_complete()
{
	return sd_write_complate;
}

void set_sd_read_complete(bool value)
{
	sd_read_complate = value;
}

void set_sd_write_complete(bool value)
{
	sd_write_complate = value;
}
