 ...
 *
 * Source file: D:\UAVCANread\uavcan��ֲ�̳̼��ο�ʾ��\dsdl_compiler\uavcan\equipment\gnss\1062.RTCMStream.uavcan
 */
...
void handle_rtcm(CanardRxTransfer *transfer)
{
	...
	/** ����protocol_id,�����õ�rtcm����Э�鶼��V3�汾�� */
	canardDecodeScalar(transfer, 0, 8, false,&protocol_id);
	
	/** ���ֽڽ���rtcm����,transfer->payload_len-1,����Ϊǰ��ĵ�һ���ֽ���protocol_id,�ڶ�����ʼ����rtcm���� */
