 ...
 *
 * Source file: /home/fu/Documents/libcanard-master/dsdl_compiler/dsdl-master/uavcan/protocol/debug/LogLevel.uavcan
 */
#include "LogLevel.h"
#include "canard.h"
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_protocol_debug_LogLevel_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
