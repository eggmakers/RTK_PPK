 ...
 *
 * Source file: /home/fu/Documents/libcanard-master/dsdl_compiler/dsdl-master/uavcan/protocol/debug/16383.LogMessage.uavcan
 */
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    // Compound
    offset = uavcan_protocol_debug_LogLevel_encode_internal((void*)&source->level, msg_buf, offset, 0);
  ...
  uint8_t CANARD_MAYBE_UNUSED(tao))
{
    ...
    // Compound
    offset = uavcan_protocol_debug_LogLevel_decode_internal(transfer, 0, (void*)&dest->level, dyn_arr_buf, offset, tao);
    if (offset < 0)
    {
        ret = offset;
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_protocol_debug_LogMessage_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
